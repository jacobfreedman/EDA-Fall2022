...
> Answer: A matrix requires that all data stored must be the same type (e.g. all data is numeric or all data is character). This data frame contains numeric data (the test scores), character data (the student names), and logical data (did they pass).
