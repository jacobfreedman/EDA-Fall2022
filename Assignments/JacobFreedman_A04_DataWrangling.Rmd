...
#2 Looking at dimensions and column names of 4 datasets. There are many other functions to use, such as "head" or "tail", but that results in a large total output.  
...
Month <- month(EPA.NC.TOTAL.SelectedSites$Date)
Year <- year(EPA.NC.TOTAL.SelectedSites$Date)
EPA.NC.TOTAL.SelectedSites <- cbind(EPA.NC.TOTAL.SelectedSites, Month, Year)
#9
